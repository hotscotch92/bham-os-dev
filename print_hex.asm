...
print_hex:
        ...
        ; use si to keep track of the current char in our template string mov si, print_hex_HEX_OUT + 2
        mov si, print_hex_HEX_OUT + 2

        ; start a counter of how many nibbles we've processed, stop at 4
        mov cx, 0

print_hex_next_character:
...
print_hex_add_7:
        ...
        add bh, 0x7 ; For upper case
        add bh, 32 ; For lower case

        ; add the current nibble's ASCII
        jmp print_hex_add_character_hex
